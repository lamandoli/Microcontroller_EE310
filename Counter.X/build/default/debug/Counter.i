...
# 254 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include/pic18_chip_select.inc" 3
# 1 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include\\proc/pic18f47k42.inc" 1 3
# 47 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include\\proc/pic18f47k42.inc" 3
...
TOSU equ 03FFFh
# 35665 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include\\proc/pic18f47k42.inc" 3
...
# 255 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include/pic18_chip_select.inc" 2 3
...
Main_Loop:
    ; ==== Check if both ((PORTB) and 0FFh), 0, a and ((PORTB) and 0FFh), 1, a are HIGH ====
    BTFSS PORTB, 0 ; Is ((PORTB) and 0FFh), 0, a HIGH?
    GOTO Check_Buttons ; If not, skip to Check_Buttons

    BTFSS PORTB, 1 ; Is ((PORTB) and 0FFh), 1, a HIGH?
...
Check_Buttons:
    BTFSS PORTB, 0 ; Check ((PORTB) and 0FFh), 0, a for COUNT_UP
    GOTO CHECK_B
    GOTO COUNT_UP
...
CHECK_B:
    ...
    GOTO Main_Loop
    GOTO COUNT_DOWN
; If ((PORTB) and 0FFh), 0, a is HIGH (Button A pressed), continue here
COUNT_UP:
    ...
    GOTO Main_Loop ; Go back to check ((PORTB) and 0FFh), 0, a and continue only if HIGH
