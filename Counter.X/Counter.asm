...
// Title: Counter 
//----------------------------- 
// Purpose: Demonstrate counting on 7-segment display. Using a PIC18F47K42 microcontroller
//          we will make a 7-segment display count up, count down, and hold 
//          a value. There are 2 inputs, RB0 and RB1. When RB0 is high(3.3V) the display 
//          will increment. When RB1 is high, the display will decrement. If both RB0
//	    and RB1 are high, the display will reset to 0. The outputs are RD0-RD6. The
//          outputs are coded in hex to display the corresponding digit/character on the display.
...
// Versions: V6.20: 3/8/2025 - First version  
