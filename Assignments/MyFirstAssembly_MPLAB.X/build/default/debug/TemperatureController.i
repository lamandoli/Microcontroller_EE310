# 1 "TemperatureController.asm"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 286 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "TemperatureController.asm" 2
# 15 "TemperatureController.asm"
;----------------
; FILE DIRECTIVES
;----------------
...
# 19 "TemperatureController.asm" 2
# 1 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\include/xc.inc" 1 3




# 1 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include/pic18.inc" 1 3





# 1 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include/pic18_chip_select.inc" 1 3
# 239 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include/pic18_chip_select.inc" 3
# 1 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include\\proc/pic18f46k42.inc" 1 3
# 47 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include\\proc/pic18f46k42.inc" 3
...
TOSU equ 03FFFh
# 36169 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include\\proc/pic18f46k42.inc" 3
...
# 240 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include/pic18_chip_select.inc" 2 3
# 7 "C:/Users/laman/.mchp_packs/Microchip/PIC18F-K_DFP/1.14.301/xc8\\pic\\include/pic18.inc" 2 3
...
# 20 "TemperatureController.asm" 2
...
_start1:
    ...
    BRA HEXtoBCD
_start2:
    MOVLW 15 ; this is the input value ; Move literal(15 ; this is the input value) to WREG
    MOVWF 0X20 ; Move literal(15 ; this is the input value) to location 0x20
    MOVLW -5 ; this is the input value ; Move literal(-5 ; this is the input value) to WREG
    MOVWF 0X21 ; Move literal(-5 ; this is the input value) to location 0x21
    MOVF 0x21, W ; Load measuredTemp from register 0x21 into WREG

;;--------------------------------------------------
;; Check 0x33 of -5 ; this is the input value (see if negative)
;;--------------------------------------------------
;CLRF 0x33 ; Clear 0x33 flag (default = positive)
;BTFSS 0x21, 7 ; Check if `-5 ; this is the input value` is negative (bit 7 = 1)
;GOTO HEXtoBCD ; If -5 ; this is the input value is positive, skip 0x33 check
;; If measuredInputTemp is negative:
;MOVLW 0x01
;MOVWF 0x33 ; Set the 0x33 flag to 1 because -5 ; this is the input value is negative
...
;GOTO LED_OFF
    ...
    GOTO _SKIP1 ; If not equal, skip setting 0x22 ;, goto SKIP1
    CLRF 0x22 ; ; If equal, set 0x22 ; = 0
...
;GOTO LED_HOT
    ...
    GOTO _SKIP2 ; If not greater than, skip setting 0x22 ;, goto SKIP2
    MOVLW 2 ; Load WREG with 2
    MOVWF 0x22 ; ; If greater than, set 0x22 ; = 2
...
;GOTO LED_COOL
    ...
    MOVWF 0x22 ; ; If less than, set 0x22 ; = 1
...
;---------------------------------------
; HEX to BCD conversion for 15 ; this is the input value
;---------------------------------------
HEXtoBCD:
    CLRF 0x31 ; Clear counter
    MOVLW 15 ; this is the input value ; WREG = 15 ; this is the input value
    ...
    MOVLW 100 ; Sets up WREG for Loop100s conversion
     ; Converts 100s place of 15 ; this is the input value to BCD
Loop100sRef:
    ...
    MOVLW 10 ; Sets up WREG for Loop10s conversion
                          ; Converts 10s place of 15 ; this is the input value to BCD
Loop10sRef:
    INCF 0x31, F ; increment quotient for every 10 subtraction
    SUBWF 0x32, F ; subtract 10 (F = F - W)
    ...
    MOVFF 0x32, 0x60 ; Places 1's place value into 0x60
                          ; Converts 10s place of 15 ; this is the input value to BCD
;--------------------------------------------
; HEX to BCD conversion for -5 ; this is the input value
;--------------------------------------------
    CLRF 0x31 ; Clear counter
    MOVLW -5 ; this is the input value ; WREG = -5 ; this is the input value
    MOVWF 0x32 ; store numerator in 0x32
    BTFSC 0x32,7 ; Bit check bit 7, if clear skip next line
    NEGF 0x32 ; If negative, take 2's comp
    MOVLW 100 ; Sets up WREG for Loop100s conversion
         ; Converts 100s place of -5 ; this is the input value to BCD
...
Loop100sMeas:
    ...
    MOVLW 10 ; Sets up WREG for Loop10s conversion
                          ; Converts 10s place of -5 ; this is the input value to BCD
